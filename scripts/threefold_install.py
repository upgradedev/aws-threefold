#!/usr/bin/env python3
"""The installer moved to src/threefold/tools/threefold_install.py, because the stack serves it from there at /install.py.

This file runs that one in this module's own namespace, so
`python scripts/threefold_install.py ...` works as it always did, and code that
...
_MOVED_TO = os.path.normpath(
    os.path.join(os.path.dirname(os.path.abspath(__file__)), os.pardir, "src", "threefold", "tools", "threefold_install.py")
)
