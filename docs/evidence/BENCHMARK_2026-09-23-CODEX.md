...
| Refusals per run | 0.00 | 0.00 | 0.17 |
| Refusals by gate | none | none | UNREADABLE_WRITE 3 |
| Turns (mean / median) | 8.1 / 8.0 | 7.7 / 7.0 | 8.7 / 8.0 |
| Seconds (mean / median) | 58 / 59 | 57 / 57 | 68 / 65 |
| Cost per run, USD (mean) | n/a | n/a | n/a |
| Tokens per run (mean, incl. cache) | 146251 | 137086 | 169571 |
| Shipped tests edited or deleted by the agent | 3 | 2 | 3 |
...
**Overhead of Threefold against no guidance** (ratio of means): turns 1.07x, time 1.18x, cost n/a.
