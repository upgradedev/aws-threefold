...
| Public repository | **BLOCKED, owner action** | Twenty-two commits on local `main`, no remote. One command, in `docs/RUNBOOK.md` step 2 |
...
| Test suite | 124 passed in 3.2s, hermetic under `THREEFOLD_OFFLINE=1` |
